...
<body>
  ...
  <header class="header">
    <nav class="navbar navbar-expand-lg  py-3 bg-danger ">
      <div class="container"><a href="#" class="navbar-brand text-uppercase font-weight-bold"><img src="img/logo.png"
            alt="logo"></a>
    ...
    <p><iframe
        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d933061.0958704244!2d89.765042!3d24.003901000000003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xaf20e065063324be!2sBangladesh%20Red%20Crescent%20Society!5e0!3m2!1sen!2sus!4v1614852900683!5m2!1sen!2sus"
        width="1425" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p>
  </header>
  <main>
      ...
      <div class="row pt-5 mt-3">
        <div class="col-lg-6 wow fadeIn mb-5 text-center text-lg-left">
          <div class="white-text">
            ...
            <p class="wow fadeInLeft" data-wow-delay="0.3s">
              <p></p><strong>Physical & Mailing Address</strong>
              <br>Bangladesh Red Crescent Society
            ...
            <p class="wow fadeInLeft" data-wow-delay="0.3s">
              <p><strong>Contact Information</strong>
                <br>Tel: (880) +88 02 48310188 / +88 02 48310189;</br>
                <br>Fax: +88 02 9352303</br>
                <br>Email: info@bdrcs.org</br>
        ...
        <div class="col-lg-6 wow fadeIn">
          <div class="wrapper">
            ...
            <!--form start-->
            <form name="form" method="post" action="feedback.php" OnSubmit="return fncValidate();" autocomplete="off">
      ...
      <div class="row text-center text-xs-center text-sm-left text-md-left">
        <div class="col-xs-12 col-sm-4 col-md-4">
          ...
          <ul class="list-unstyled quick-links">
            ...
            <li><a href="why_become_donor.php"><i class="fa fa-angle-double-right"></i>Why become donor</a>
            </li>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
          ...
          <ul class="list-unstyled quick-links">
            ...
            <li><a
                href="https://www.who.int/news-room/q-a-detail/vaccines-and-immunization-what-is-vaccination?adgroupsurvey={adgroupsurvey}&gclid=Cj0KCQiA-aGCBhCwARIsAHDl5x-Dt6eUVgLSfMqKM-k9kwr3QcCzZZMN9UD6iWOVr6zobnNqGTV4cfUaAkoYEALw_wcB"><i
                  class="fa fa-angle-double-right"></i>Corona vaccine</a></li>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
          <h5>Quick links</h5>
          <ul class="list-unstyled quick-links">
            <li><a href="search_blood.html"><i class="fa fa-angle-double-right"></i>Search Blood</a></li>
            <li><a
                href="https://www.unicef.org/bangladesh/en/stories/boosting-immunity-vitamin-campaign-reaches-over-20-million-bangladeshi-children-during"><i
                  class="fa fa-angle-double-right"></i>Health tips</a></li>
