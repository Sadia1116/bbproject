...
<!--css-->
<link rel="stylesheet" href="css/search_blood.css">
<body>
...
<main>
    <div class="wrapper">
        ...
        <!--form start-->
    <form n method="post" action="bloodbank.php"  OnSubmit="return fncValidate();" autocomplete="off">
      <table align="center" width="400" border="0">

        <tr><td>Blood Group: </td><td><div class="input-group">
          <select name="valueToSearch" id="Blood Group">
          ...
          <tr><td></td><td><input type="submit" name="search" value="Submit" class="btn">&nbsp&nbsp
...
<script src="js/searchblood.js"></script>
